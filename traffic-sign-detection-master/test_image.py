...
if __name__ == "__main__":
    img = cv2.imread("/home/hc/flush/traffic-sign-detection-master/data/test_images/JPEGImages/sign_86.jpg")
    ...
    clf = joblib.load("/home/hc/flush/traffic-sign-detection-master/svm_hog_classification/svm_model.pkl")
